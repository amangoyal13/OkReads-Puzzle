...
export class ReadingListController {
  ...
  async markBookAsFinished(@Param() params: {id: string}, @Body() date: { finishedDate: string }): Promise<void> {
    return await this.readingList.updateBook(params.id, date.finishedDate);
  }
}
